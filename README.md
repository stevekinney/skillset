...
- Every command supports `--json` (stable shapes, documented in `documentation/ui-readiness.md`); text output respects `NO_COLOR` / `FORCE_COLOR` and disables color on non-TTY pipes.
